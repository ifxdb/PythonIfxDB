...
class IfxDbTestCase(unittest.TestCase):
  ...
  def test_int(self, conn):
    return_value = 0
    stmt, return_value = ifx_db.callproc(conn, 'PROCESSINT', (return_value,))
    print "ProcessINT:", return_value

  def test_varchar(self, conn):
    return_value = ""
    stmt, return_value = ifx_db.callproc(conn, 'PROCESSVAR', (return_value,))
  ...
  def test_xml(self, conn):
    ...
    stmt, return_value = ifx_db.callproc(conn, 'PROCESSXML', (return_value,))
